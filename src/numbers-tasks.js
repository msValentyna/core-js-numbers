...
function getAngleBetweenVectors(x1, y1, x2, y2) {
  ...
  const magnitudeVector1 = Math.sqrt(x1 * x1 + y1 * y1);
  const magnitudeVector2 = Math.sqrt(x2 * x2 + y2 * y2);

  const cos = scalarProduct / (magnitudeVector1 * magnitudeVector2);
...
// console.log(getNumberValue(new Number(5)));
// console.log(getNumberValue(Number(-5)));
